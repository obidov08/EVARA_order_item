...
from shop.views import  wishilst, LoginUserView, logout_user, register_user, shop_page, get_cart_page, ProfileUserView
from shop.views.cart import add_to_cart, del_cart_item
from shop.views.user import cart_, ChangePasswordView
...
urlpatterns = [
    ...
    path('change-password/', ChangePasswordView.as_view(), name="change_passowrd"),
